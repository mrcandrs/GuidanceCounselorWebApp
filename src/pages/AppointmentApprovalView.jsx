...
const handleToggleTimeSlot = async () => {
  ...
  return (
    <div className="page-container dashboard-scrollable-form">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 appointments-scroll-container" style={{ maxHeight: 'calc(100vh - 300px)', overflowY: 'auto', overflowX: 'hidden', paddingRight: '8px' }}>
